const BLOG = {
  ...
  SINCE: 2016,
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'auto', // ['light', 'dark', 'auto'], // light 日間模式 ， dark夜間模式， auto根據時間和主題自動夜間模式
...
// 歡迎語
  ...
  ALGOLIA_RECREATE_DATA:
    ...
    process.env.npm_lifecycle_event === 'build', // 为true时重新构建索引数据; 默认在build时会构建
  ...
  //   ********挂件组件相关********
  // Chatbase
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'f1fTTAG4xOZcIKgZIGPxd', // 是否显示chatbase机器人 https://www.chatbase.co/
  // 悬浮挂件
  WIDGET_PET: process.env.NEXT_PUBLIC_WIDGET_PET || true, // 是否显示宠物挂件
  WIDGET_PET_LINK:
    process.env.NEXT_PUBLIC_WIDGET_PET_LINK ||
    'https://raw.githubusercontent.com/imuncle/live2d/master/model/touma/touma.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOJ_e_BA', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOJ_e_BM4CYKGS', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-2858848283461078', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '2688896723', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
